      ...
      <div className="editor-root">
        <aside className="sidebar">
          ...
          <nav className={`sidebar-nav ${showMenu ? "nav-open" : ""}`}>
            ...
            <a href="/receipt-editor" className="nav-item active"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>New Receipt</a>
